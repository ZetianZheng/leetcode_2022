...
class Solution {
    // recursion: postOrder construct the new node, use a hashmap to record the visited nodes
    // 难点：hashMap 想到 oldNode - newNode
    ...
    public Node copyRandomList(Node head) {
        ...
        Node nNode = new Node(head.val, null, null);
        
        // been visited:
        oldNewMap.put(head, nNode);
